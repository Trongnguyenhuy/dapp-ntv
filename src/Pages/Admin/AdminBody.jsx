    ...
    <div className="flex flex-row min-h-screen bg-gray-100 text-gray-800">
      <aside className="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-gray-800">
        ...
        <div className="sidebar-content px-4 py-6">
          ...
          <li className="my-px">
            <Link className="text-white" to="/farm">
              Farm
            </Link>
          </li>
          <li className="my-px">
            <Link className="text-white" to="/pool">
              Pool
            </Link>
          </li>
        </div>
            ...
            >
              ...
              >
                <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                  ...
                  <input
                    id="name"
                    value={farmMultiplier}
                    onChange={(e) => setFarmMultiplier(e.target.value)}
                    className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                  />
        ...
        <footer className="footer px-4 py-6">
          <div className="footer-content">
            <p className="text-sm text-gray-600 text-center">
              © NTV 2023. All rights reserved.{" "}
              <a href="https://twitter.com/iaminos">by NTV</a>
            </p>
          </div>
        </footer>
      </main>
